                ...
                <li class="gift-info" v-for="item in list">
                    <a v-bind:href="detailUrl+item.commodityContractId">
                        <div class="product-img">
                            <img v-bind:src="item.img+'?v=${jsVersion}'">
                        </div>
                        <div>
                            <p class="gift-name">{{item.name}}</p>
                            <p class="gift-detail clearfix"><span class="gift-money">￥{{item.unitPrice}}元/{{item.unit}}</span><span class="desc">{{item.standardUnitMultiple}}{{item.unit}}/{{item.standardUnitName}}</span></p>
                        </div>
                    </a>
                </li>
            </ul>
...
<script type="text/javascript" src="${staticPath}/static/js/views/sellIn.js?v=${jsVersion}"></script>
</body>
</html>