...
(
  EXPRESS_COMPANY_ID   BIGINT(18) NOT NULL AUTO_INCREMENT,
  COMPANY_EXP_NAME     VARCHAR(100),
  COMPANY_SIMPLE_NAME  VARCHAR(100),
  PHONE                VARCHAR(100),
  IMGURL               VARCHAR(256),
  URL                  VARCHAR(256),
  NOTE                 VARCHAR(512),
...
ALTER TABLE EXPRESS_COMPANY COMMENT '物流公司';
...
(
  USER_INFO_ID         BIGINT(18) NOT NULL COMMENT '经纪人用户id',
...
(
  ...
  STANDARD_PRICE       BIGINT(18) COMMENT '规格单位价格, 单位分',
...
(
  ...
  SIGN_QUANTITY_MIN    INT COMMENT '报名人数下限',
  SIGN_QUANTITY_MAX    INT COMMENT '报名人数上限',
  MULTI_OBJ_DETAIL     VARCHAR(512) COMMENT '多奖项奖品明细， json格式，包含 奖品等级、奖品名称、奖品数量',
...
(
  ...
  ORDER_GROUP_ID       VARCHAR(64) COMMENT '订单组id',
  SIGN_SEQ             INT COMMENT '参加活动序号， 针对对应的活动，报名或参加的顺序编号',
  USER_INFO_ID         BIGINT(18) COMMENT '用户id',
  CONVERT_OBJ_ID       BIGINT(18) COMMENT '兑换物品id',
  COMMODITY_CONTRACT_ID BIGINT(18) COMMENT '商品合约信息id',
  STATUS               VARCHAR(32) COMMENT '状态： ',
  ...
  EXPRESS_INFO_ID      BIGINT(18) COMMENT '物流跟踪信息id',
  WIN                  VARCHAR(32) COMMENT '是否中奖,  TRUE:中奖     FALSE:未中奖',
  WIN_LEVEL            VARCHAR(32) COMMENT '中奖等级， 1：一等奖   2：二等奖  以此类推',
  ...
  MULTI_OBJ_DETAIL     VARCHAR(1024) COMMENT '多奖项信息, json格式 包含奖品等级、奖品名称',
...
(
  ...
  VALID                ENUM('FALSE', 'TRUE') COMMENT '是否有效',
  CREATE_TIME          DATETIME COMMENT '创建时间',
...
(
  ...
  COMMODITY_UNIT_QUANTITY DECIMAL(20,0) COMMENT '商品单位数量',
  COMMODITY_UNIT_PRICE BIGINT(18)  COMMENT '商品单位单价, 分为单位',
  COMMODITY_STANDARD_QUANTITY DECIMAL(20,0) COMMENT '商品规格单位数量',
  COMMODITY_STANDARD_PRICE BIGINT(18)  COMMENT '商品规格单位单价 分为单位',
  FEE_PERCENT          DECIMAL(20,0) COMMENT '手续费比例, 百分比为单位',
  FEE_PRICE            BIGINT(18)  COMMENT '手续费, 单位为分',
  COUPON_INFO          VARCHAR(1024) COMMENT '优惠券折扣明细， json格式，包含优惠券id， 折扣金额，折扣注释信息  {couponDetailId:123, price:1000, remark: "首单减10元"}',
...
(
  ...
  IS_BROKER            ENUM('FALSE', 'TRUE') COMMENT '是否可作为经纪人,TRUE:可作为经纪人   FALSE：不可作为经纪人',
  BROKER_USER_ID       BIGINT(18) COMMENT '经纪人用户id',
  REFERER_USER_ID      BIGINT(18) COMMENT '推荐人用户id',
  PRIMARY KEY (USER_INFO_ID),
